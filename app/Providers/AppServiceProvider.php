...
class AppServiceProvider extends ServiceProvider
{
    ...
    {
        $payfastMoneyFile = base_path('vendor/sharifur/payfast/src/Money.php');
        if (file_exists($payfastMoneyFile)) {
            require_once $payfastMoneyFile;
        }
    }
    ...
    public function boot()
    {
        ...
        // Register Order Observer for automatic referral completion
