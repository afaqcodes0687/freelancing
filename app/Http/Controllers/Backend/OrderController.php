...
class OrderController extends Controller
{
    ...
    public function update_manual_payment(Request $request)
    {
        ...
        // ✅ Create affiliate commission for this manually approved payment
        try { app(AffiliateCommissionService::class)->createForOrder((int) $request->order_id); } catch (\Exception $e) {}
