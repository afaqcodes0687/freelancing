...
{
    /**
     * GET /api/v1/client/identity-verification/status
     * Returns the current identity verification record and status for the logged-in client.
     */
    ...
    /**
     * POST /api/v1/client/identity-verification/submit
    ...
    /**
     * GET /api/v1/client/identity-verification/countries
    ...
    /**
     * POST /api/v1/client/identity-verification/states
    ...
    /**
     * POST /api/v1/client/identity-verification/cities
