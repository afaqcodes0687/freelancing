    ...
    public function register(Request $request)
    {
        ...
        if (!is_null($user)) {
            ...
            try {
                ...
                \Log::error('API Freelancer referral binding failed: ' . $e->getMessage());
            }
            //create freelancer wallet with signup bonus
            ...
            // Add default subscription if any (same as website registration)
