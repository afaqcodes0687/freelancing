...
class ReportController extends Controller
{
    public function all()
    {
        $reports = Report::where('client_id',Auth::guard('web')->id())
    ...
    {
        return view('frontend.user.client.report.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('client.reports.all')->with(toastr_success(__('Report submitted to admin successfully')));
    }
    ...
    public function show($id)
    {
        ...
        return view('frontend.user.client.report.show', compact('report'));
    }
}
