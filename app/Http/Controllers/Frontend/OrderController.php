...
class OrderController extends Controller
{
    ...
    public function user_order_confirm(Request $request)
    {
        ...
        $all_gateway = ['wallet', 'paypal', 'manual_payment', 'mollie', 'paytm', 'stripe', 'razorpay', 'flutterwave', 'paystack', 'marcadopago', 'instamojo', 'cashfree', 'payfast', 'midtrans', 'squareup', 'cinetpay', 'paytabs', 'billplz', 'zitopay', 'sitesway', 'toyyibpay', 'authorize_dot_net', 'kineticpay', 'awdpay', 'iyzipay', 'yoomoney', 'coinpayments', 'paypro'];
        ...
        if ($request->selected_payment_gateway == 'manual_payment') {
            ...
            return (new OrderService())->wallet_order(
                $request,
                $client_id,
                $user->id,
                $project_or_job,
