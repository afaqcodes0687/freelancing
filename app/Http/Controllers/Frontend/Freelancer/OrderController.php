...
class OrderController extends Controller
{
    ...
    {
        $freelancer_id = Auth::guard('web')->user()->id;
        $order_details = Order::with(['user:id,first_name,last_name,email,phone,country_id,state_id,city_id,image,username,created_at,user_verified_status','order_submit_history', 'job'])
            ->whereHas('user')
