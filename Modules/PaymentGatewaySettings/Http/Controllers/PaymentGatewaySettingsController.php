    ...
    public function payment_gateway(Request $request)
    {
        if($request->isMethod('post')){
            $field_rules = [
                ...
                // paypro
                'paypro_gateway' => 'nullable|string|max:191',
                'paypro_test_mode' => 'nullable|string|max:191',
                'paypro_preview_logo' => 'nullable|string|max:191',
                'paypro_base_url' => 'nullable|string|max:191',
                'paypro_username' => 'nullable|string|max:191',
                'paypro_password' => 'nullable|string|max:191',
                'paypro_client_id' => 'nullable|string|max:191',
                'paypro_client_secret' => 'nullable|string|max:191',
