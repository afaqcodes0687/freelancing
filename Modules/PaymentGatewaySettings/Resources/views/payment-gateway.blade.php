                            ...
                            <form action="{{route('admin.payment.settings.gateway')}}" method="POST"
                                ...
                                <div class="accordion-wrapper">
                                    <div id="accordion-payment">
                                            ...
                                            <div id="paystack_settings_content" class="collapse"
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <p class="margin-bottom-30 margin-top-20 info-paragraph">
                                                        ...
                                                        <br>
                                                        <span class="bg-gray mt-3 p-3">{{ url('/frontend/payments/paystack-ipn') }}</span>
                                                    </p>
                                                    <div class="switch">
                                                    ...
                                                    <div class="single-input">
                                                     ...
                                                     <div class="single-input">
                                                         ...
                                                         <input type="text" name="payfast_itn_url" id="payfast_itn_url"
                                                                ...
                                                                class="form-control">
                                                         <small class="text-muted">{{ __('If left empty, the system will use the default dynamic IPN URLs listed below:') }}</small>
                                                         <div class="mt-2" style="background-color: #f8f9fa; padding: 10px; border-radius: 4px; border: 1px solid #dee2e6;">
                                                             <small class="d-block"><strong>{{ __('Subscription IPN URL:') }}</strong> {{ route('bs.payfast.ipn.subscription') }}</small>
                                                             <small class="d-block"><strong>{{ __('Freelancer Wallet IPN URL:') }}</strong> {{ route('freelancer.payfast.ipn.wallet') }}</small>
                                                             <small class="d-block"><strong>{{ __('Client Wallet IPN URL:') }}</strong> {{ route('client.payfast.ipn.wallet') }}</small>
                                                             <small class="d-block"><strong>{{ __('Package Promotion IPN URL:') }}</strong> {{ route('freelancer.bp.payfast.ipn.package') }}</small>
                                                         </div>
                                                     </div>
                                        ...
                                        {{-- PayPro --}}
                                        <div class="card">
                                            <div class="card-header" id="paypro_pago_content">
                                                <h5 class="mb-0">
                                                    <button class="btn btn-link" type="button" data-bs-toggle="collapse"
                                                            data-bs-target="#paypro_settings_content"
                                                            aria-expanded="false">
                                                        <span class="page-title"> {{__('PayPro Settings')}}</span>
                                                    </button>
                                                </h5>
                                            </div>

                                            <div id="paypro_settings_content" class="collapse"
                                                 data-parent="#accordion-payment">
                                                <div class="card-body">

                                                    <div class="switch">
                                                        <label class="label-title mt-3"><strong>{{__('Enable/Disable PayPro')}}</strong></label>
                                                        <input class="custom-switch" type="checkbox"
                                                               id="paypro_gateway" name="paypro_gateway"
                                                               @if(!empty(get_static_option('paypro_gateway'))) checked @endif>
                                                        <label class="switch-label"
                                                               for="paypro_gateway">{{__('Enable/Disable PayPro')}}</label>
                                                    </div>
                                                    <div class="switch">
                                                        <label class="label-title mt-3"><strong>{{__('Enable/Disable Test Mode PayPro')}}</strong></label>
                                                        <input class="custom-switch" type="checkbox"
                                                               id="paypro_test_mode" name="paypro_test_mode"
                                                               @if(!empty(get_static_option('paypro_test_mode'))) checked @endif>
                                                        <label class="switch-label"
                                                               for="paypro_test_mode">{{__('Enable/Disable Test Mode PayPro')}}</label>
                                                    </div>
                                                    <div class="single-input mt-3">
                                                        <x-backend.image :title="__('PayPro Logo')"
                                                                         :name="'paypro_preview_logo'"
                                                                         :dimentions="'160x50'"/>
                                                    </div>
                                                    <div class="single-input">
                                                        <label for="paypro_base_url"
                                                               class="label-title mt-3">{{__('Base URL')}}</label>
                                                        <input type="text" name="paypro_base_url"
                                                               value="{{get_static_option('paypro_base_url') ?? 'https://demoapi.PayPro.com.pk'}}"
                                                               class="form-control">
                                                    </div>
                                                    <div class="single-input">
                                                        <label for="paypro_username"
                                                               class="label-title mt-3">{{__('Username')}}</label>
                                                        <input type="text" name="paypro_username"
                                                               value="{{get_static_option('paypro_username')}}"
                                                               class="form-control">
                                                    </div>
                                                    <div class="single-input">
                                                        <label for="paypro_password"
                                                               class="label-title mt-3">{{__('Password')}}</label>
                                                        <input type="password" name="paypro_password"
                                                               value="{{get_static_option('paypro_password')}}"
                                                               class="form-control">
                                                    </div>
                                                    <div class="single-input">
                                                        <label for="paypro_client_id"
                                                               class="label-title mt-3">{{__('Client ID')}}</label>
                                                        <input type="text" name="paypro_client_id"
                                                               value="{{get_static_option('paypro_client_id')}}"
                                                               class="form-control">
                                                    </div>
                                                    <div class="single-input">
                                                        <label for="paypro_client_secret"
                                                               class="label-title mt-3">{{__('Client Secret')}}</label>
                                                        <input type="password" name="paypro_client_secret"
                                                               value="{{get_static_option('paypro_client_secret')}}"
                                                               class="form-control">
                                                    </div>
                                                </div>
                                            </div>
