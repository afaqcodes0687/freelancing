...
class SubCategoryController extends Controller
{
    ...
    public function all_subcategory(Request $request)
    {
        if($request->isMethod('post')){
            ...
            SubCategory::create([
                ...
                'hero_cta_anchor' => $request->hero_cta_anchor,
                'image' => $request->image,
            ]);
    ...
    public function edit_subcategory(Request $request)
    {
        ...
        SubCategory::where('id',$request->edit_sub_category_id)->update([
            ...
            'seo_content' => $request->edit_seo_content,
            'hero_cta_text' => $request->edit_hero_cta_text,
            'hero_cta_anchor' => $request->edit_hero_cta_anchor,
            'image' => $request->image,
        ]);
