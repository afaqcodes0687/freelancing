    ...
    (function($){
        ...
        $(document).ready(function(){
            ...
            $(document).on('click','.edit_sub_category_modal',function(){
                ...
                let seo_content = $(this).data('seo_content');
                let hero_cta_text = $(this).data('hero_cta_text');
                let hero_cta_anchor = $(this).data('hero_cta_anchor');
                ...
                $('#edit_seo_content').val(seo_content);
                $('#edit_hero_cta_text').val(hero_cta_text);
                $('#edit_hero_cta_anchor').val(hero_cta_anchor);
