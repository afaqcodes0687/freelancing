            ...
            <form action="{{route('admin.subcategory.edit')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="edit_seo_content">{{ __('SEO Content (HTML supported)') }}</label>
                        <textarea name="edit_seo_content" id="edit_seo_content" class="form-control" rows="5" placeholder="{{ __('Enter SEO Content') }}"></textarea>
                    </div>
                    <x-form.text :title="__('Hero CTA Text')" :type="__('text')" :name="'edit_hero_cta_text'" :id="'edit_hero_cta_text'" :value="''" :placeholder="__('e.g. Browse Professionals')"/>
                    <x-form.text :title="__('Hero CTA Anchor')" :type="__('text')" :name="'edit_hero_cta_anchor'" :id="'edit_hero_cta_anchor'" :value="''" :placeholder="__('e.g. #professionals')"/>
