                ...
                <div class="modal-body">
                    ...
                    <div class="popup-contents-inner profile-border-top">
                        <div class="withdrawal-single-item">
                            <span class="withdrawal-single-item-subtitle">{{ __('Available withdrawable balance') }}</span>
                            <h2 class="withdrawal-single-item-balance mt-2">{{ float_amount_with_currency_symbol($withdrawable_balance ?? 0) }}</h2>
                            <!-- <p class="text-muted small mt-1">{{ __('From job earnings only') }}</p> -->
                        </div>
                    </div>
                    <div class="popup-contents-form custom-form profile-border-top">
                        <div class="single-input">
                            ...
                            <div class="text-danger mt-1" id="withdraw_amount_error" style="font-size: 12px; display: none;"></div>
                        </div>
                        <div class="single-input">
