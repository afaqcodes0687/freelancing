        ...
        <div class="modal-content">
            ...
            <form action="{{route('admin.project.promote.settings')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <x-form.text :title="__('Impression Limit')" :type="'number'" :name="'impression_limit'" :id="'impression_limit'" :placeholder="__('Enter impression limit')"/>
                    <x-form.text :title="__('Click Limit')" :type="'number'" :name="'click_limit'" :id="'click_limit'" :placeholder="__('Enter click limit')"/>
