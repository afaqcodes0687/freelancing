...
class GeneralSettingsController extends Controller
{
    ...
    public function affiliate_settings(Request $request)
    {
        if ($request->isMethod('post')) {
            return (new GeneralSettingsService)->affiliate_settings($request);
        }
        return view('generalsettings::affiliate-settings');
    }
