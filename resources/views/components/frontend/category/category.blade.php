                                ...
                                <div class="categorySub-list nav-horizontal-scroll has-arrows" id="categoryWrap-list">
                                   ...
                                   <ul class="categorySub-list-slide" id="categoryslide-list">
                                        @foreach($all_categories as $category)
                                            <li class="categorySub-list-slide-list">
                                                <a href="{{ route('category.projects',$category->slug) }}" class="categorySub-list-slide-link">
                                                    {{ $category->category }}<span class="mobileIcon"></span>
                                                </a>
                                                ...
                                                @if($subs->count() > 12)
                                                    <ul class="categorySub-slide-submenu subcategory-scroll">
                                                        @foreach($subs as $sub_category)
                                                            <li>
                                                                <a href="{{ route('subcategory.landing', ['category_slug' => $category->slug, 'sub_slug' => $sub_category->slug]) }}">
