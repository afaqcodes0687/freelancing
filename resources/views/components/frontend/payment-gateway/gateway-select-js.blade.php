    ...
    (function($){
        ...
        $(document).ready(function(){
            ...
            $(document).on('click', '.payment_getway_image ul li',function(){
                ...
                // update the hidden selected_payment_gateway input within the same form/modal
                const $wrapper = $(this).closest('.payment-gateway-wrapper');
                $wrapper.closest('form').find('input[name="selected_payment_gateway"]').val(payment_gateway_name);
            });
