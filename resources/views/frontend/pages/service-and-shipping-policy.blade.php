...
@section('site_title', $policy->meta_title ?? $policy->title ?? __('Service & Shipping Policy'))

@section('meta_title')
    {{ $policy->meta_title ?? $policy->title ?? __('Service & Shipping Policy - Right Freelancer') }}
@endsection
                ...
                <div class="col-lg-12">
                    <div class="banner-inner-contents">
                        <ul class="inner-menu">
                            ...
                            <li class="list">{{ $policy->heading ?? $policy->title ?? __('Service & Shipping Policy') }}</li>
                        </ul>
                        <h2 class="banner-inner-title">{{ $policy->heading ?? $policy->title ?? __('Service & Shipping Policy') }}</h2>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h1 class="animate-fade-in">{{ $policy->heading ?? $policy->title ?? __('Service & Shipping Policy') }}</h1>
                ...
                <div class="col-lg-12">
                    <div class="benefit-content">
                        @if(!empty($policy->content))
                            {!! $policy->content !!}
                        @else
                            <p class="text-center py-5">Service & Shipping Policy content is currently empty. Please add content from the admin panel.</p>
                        @endif
                    </div>
                </div>
            </div>
        ...
        <section class="faq-section">
            <div class="container">
                <div class="section-title">
                    ...
                    <p>{{ __('Have questions regarding digital shipping or service fulfillment? Read our FAQs below.') }}</p>
                </div>
