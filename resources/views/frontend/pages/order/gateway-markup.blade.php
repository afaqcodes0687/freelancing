<div class="modal fade" id="paymentGatewayModal" tabindex="-1" aria-labelledby="paymentGatewayModalLabel"
    ...
    <div class="modal-dialog">
        <form action="{{ route('order.user.confirm') }}" method="post" enctype="multipart/form-data"
            id="prevent_multiple_order_submit">
                                            ...
                                            <div class="myJob-wrapper-single-milestone-item">
                                                <div class="myJob-wrapper-single-flex flex-between align-items-start">
                                                    <div class="myJob-wrapper-single-contents">
                                                        ...
                                                        <br>
                                                        <x-duration.delivery-time :class="'single-input'"
                                                            :selectClass="'form-control set_dead_line'"
                ...
                <div class="modal-footer">
                    ...
                    @if (Auth::guard('web')->check())
                        <button type="submit" class="btn-profile btn-bg-1"
                            id="order_now_only_for_load_spinner">{{ __('Order Now') }}<span
                                id="order_create_load_spinner"></span></button>
