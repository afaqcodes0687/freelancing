...
@section('site_title', $policy->meta_title ?? $policy->title ?? __('Fees and Charges'))

@section('meta_title')
    {{ $policy->meta_title ?? $policy->title ?? __('Fees and Charges - Right Freelancer') }}
@endsection
                ...
                <div class="col-lg-12">
                    <div class="banner-inner-contents">
                        <ul class="inner-menu">
                            ...
                            <li class="list">{{ __('Fees and Charges') }}</li>
                        </ul>
                        <h2 class="banner-inner-title">{{ __('Fees and Charges') }}</h2>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h1 class="animate-fade-in">{{ $policy->heading ?? $policy->title ?? __('Fees and Charges') }}</h1>
                ...
                <div class="col-lg-12">
                    <div class="benefit-content">
                        @if(!empty($policy->content))
                            {!! $policy->content !!}
                        @else
                            <p class="text-center py-5">Fees and Charges content is currently empty. Please add content from the
                                admin panel.</p>
                        @endif
                    </div>
                </div>
        ...
        <section class="faq-section">
            <div class="container">
                <div class="section-title">
                    ...
                    <p>Have questions regarding pricing? Read our FAQS.</p>
                </div>
