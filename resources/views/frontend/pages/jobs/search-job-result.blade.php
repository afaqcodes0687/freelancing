...
.read-more-btn {
    ...
    display: inline; /* ✅ inline so it's beside the text */
    margin-left: 5px;
    padding: 0;
}
                ...
                <div class="categoryWrap-wrapper-item jobDetails-padding">
                    <div class="categoryWrap-wrapper-item-inner">
                        ...
                        <div class="categoryWrap-wrapper-item-contents">
                            ...
                            <p class="single-jobs-para mt-4 job-description" data-full="{!! strip_tags($job->description) !!}">
                                {!! Str::limit(strip_tags($job->description), 300, '') !!}
                                @if(strlen(strip_tags($job->description)) > 300)
                                    <span class="dots">...</span>
                                    <button class="btn btn-link p-0 read-more-btn align-middle">{{ __('More') }}</button>
                                @endif
                            </p>
                    ...
                    <div class="categoryWrap-wrapper-item-bottom">
                        <ul class="categoryWrap-wrapper-item-bottom-list">
                            ...
                            <li class="categoryWrap-wrapper-item-bottom-list-item">
                                <span class="item-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-user-icon lucide-circle-user" style="color:#309400"><circle cx="12" cy="12" r="10"/><circle cx="12" cy="10" r="3"/><path d="M7 20.662V19a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v1.662"/></svg>
                                </span>
                            ...
                            @endif
                             ...
                             @if(moduleExists('HourlyJob'))
                                <li class="categoryWrap-wrapper-item-bottom-list-item">
                                    ...
                                    @php $employer = $job->job_creator; @endphp

                                    <span class="item-para">
                                        @if($employer && $employer->hasVerifiedPayment())
                                            {{ __('Payment Verified') }} • {{ $employer->totalSpentFormatted() }}+ {{ __('Spent') }}
                                        @else
                                            <span class="text-muted">{{ __('Payment Not Verified') }}</span>
                                        @endif
                                    </span>
                                </li>
