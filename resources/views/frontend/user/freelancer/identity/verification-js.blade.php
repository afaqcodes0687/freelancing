    ...
    (function ($) {
        ...
        $(document).ready(function () {
            ...
            $(document).on('submit', '#submit_freelancer_verify_info', function (e) {
                ...
                if (country == '' || state == '' || address == '' || national_id_number == '' || front_image == '' || back_image == '') {
                    toastr_warning_js("{{ __('All fields are required except city and zipcode!') }}");
                    return false;
                } else {
                    // Button disable + loader add
                    let $btn = $('#submit_freelancer_verify_info button[type="submit"]');
                    let btnOldText = $btn.html();
                    $btn.prop('disabled', true).html(
                        `<i class="fa fa-spinner fa-spin"></i> {{ __('Submitting...') }}`
                    );
                    ...
                    $.ajax({
                        ...
                        complete: function () {
                            // Reset button after request finish
