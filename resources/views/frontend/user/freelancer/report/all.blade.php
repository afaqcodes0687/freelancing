...
@section('content')
    <main>
        <x-breadcrumb.user-profile-breadcrumb :title="__('All Reports')" :innerTitle="__('All Reports')"/>
                            ...
                            <div class="single-profile-settings">
                                <div class="single-profile-settings-header">
                                    <div class="single-profile-settings-header-flex">
                                        ...
                                        <a href="{{ route('freelancer.report.create') }}" class="btn btn-primary">
                                            {{ __('Submit New Report') }}
                                        </a>
                                    </div>
                                </div>
                                <div class="single-profile-settings-inner profile-border-top">
                                    <div class="custom_table style-04 search_result">
                                        @include('frontend.user.freelancer.report.search-result')
                                    </div>
                                </div>
                            </div>
                        </div>
