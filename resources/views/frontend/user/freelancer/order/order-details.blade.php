                                ...
                                <div class="jobFilter-wrapper-item">
                                    <div class="jobFilter-about-clients">
                                        <div class="jobFilter-proposal-author-flex">
                                         <span class="jobFilter-proposal-author-thumb position-relative" style="display:inline-block;">
                                            ...
                                            <span class="profile-status-icon" style="
                                                ...
                                                background-color: {{ Cache::has('user_is_online_' . $order_details?->user->id) ? '#28a745' : '#6c757d' }};">
                                            </span>
                                        </span>
