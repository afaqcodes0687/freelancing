                                    ...
                                    <form id="submit_client_verify_info" enctype="multipart/form-data">
                                        ...
                                        <div class="identity-verifying">
                                            ...
                                            <div class="identity-verifying-list custom-radio {{ ($user_identity->verify_by ?? '') == 'Passport' ? 'active' : '' }}">
                                                ...
                                                <input type="hidden" name="verify_by" id="verify_by" value="{{ $user_identity->verify_by ?? 'National ID Card' }}">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="country" id="country" class="form--control country_select2">
                                                            ...
                                                            @foreach($countries as $country)
                                                                <option value="{{ $country->id }}" {{ old('country', $user_identity->country_id ?? $user->country_id ?? '') == $country->id ? 'selected' : '' }}>{{ $country->country }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                        ...
                                                        <select name="state" id="state" class="form--control state_select2 get_country_state">
                                                            ...
                                                            @foreach($states as $state)
                                                                <option value="{{ $state->id }}"
                                                                    {{ ($user_identity->state_id ?? $user->state_id) == $state->id ? 'selected' : '' }}>
                                                                    {{ $state->state }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                        ...
                                                        <select name="city" id="city" class="form--control city_select2 get_state_city">
                                                            ...
                                                            @foreach($cities as $city)
                                                                <option value="{{ $city->id }}"
                                                                    {{ ($user_identity->city_id ?? $user->city_id) == $city->id ? 'selected' : '' }}>
                                                                    {{ $city->city }}
                                                                </option>
                                                            @endforeach
                                                        </select>
