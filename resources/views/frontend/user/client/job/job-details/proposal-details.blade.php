                    ...
                    <div class="col-lg-12">
                        <div class="profile-wrapper">
                            <div class="myJob-wrapper">
                                            ...
                                            <div class="jobFilter-proposal-author-flex">
                                               <div class="jobFilter-proposal-author-thumb position-relative">
                                                    ...
                                                    <span class="profile-status-icon" style="
                                                        ...
                                                        background-color: {{ Cache::has('user_is_online_' . $proposal_details->freelancer->id) ? '#28a745' : '#6c757d' }};
                                                    ">
                                                    </span>
                                                </div>
                                                <div class="jobFilter-proposal-author-contents">
                                                    ...
                                                    <p class="jobFilter-proposal-author-contents-subtitle mt-1"> {{ $proposal_details->freelancer?->user_introduction?->title ?? '' }} · <span>{{ $proposal_details->freelancer?->user_state?->state ?? '' }}, {{ $proposal_details->freelancer?->user_country?->country ?? '' }}</span>
                                ...
                                @if($proposal_details->milestones && $proposal_details->milestones->count() > 0)
                                <div class="myJob-wrapper-single">
                                    <div class="myJob-wrapper-single-header profile-border-bottom">
                                        <h2 class="myJob-wrapper-single-title">{{ __('Milestones') }}</h2>
                                    </div>
                                    <div class="myJob-wrapper-single-contents mt-4">
                                        @foreach($proposal_details->milestones as $milestone)
                                            <div class="myJob-wrapper-single-contents-item" style="border-bottom: 1px solid #ddd; padding-bottom: 15px; margin-bottom: 15px;">
                                                <h4 style="margin-bottom: 10px;">{{ $milestone->title }}</h4>
                                                <p class="myJob-wrapper-single-contents-para" style="margin-bottom: 10px;">{{ $milestone->description }}</p>
                                                <div style="display: flex; gap: 20px; flex-wrap: wrap;">
                                                    <span><strong>{{ __('Price') }}:</strong> {{ float_amount_with_currency_symbol($milestone->price) }}</span>
                                                    <span><strong>{{ __('Revision') }}:</strong> {{ $milestone->revision }}</span>
                                                    <span><strong>{{ __('Deadline') }}:</strong> {{ $milestone->deadline }}</span>
                                                </div>
                                            </div>
                                        @endforeach
                                    </div>
                ...
                <div class="popup-contents-interview profile-border-top">
                    <div class="myJob-wrapper-single-contents">
                        ...
                        <div class="myJob-wrapper-single-list mt-3">
                            ...
                            <span class="myJob-wrapper-single-list-para">
                                {{ $proposal_details->job?->created_at->diffForHumans() }} - 
                                <a href="javascript:void(0)">{{ ucfirst($proposal_details->job?->level) }}</a>
                            </span>
