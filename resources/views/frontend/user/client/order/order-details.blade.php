                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="myJob-tabs mt-5">
                            ...
                            <div class="myOrder-single bg-white padding-20 radius-10">
                                <div class="myOrder-single-item">
                                    <div class="myOrder-single-content">
                                        <p class="myOrder-single-content-para">{{ strip_tags($order_details->job->description ?? __('No description.')) }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                                        ...
                                                        <div class="pay-now-single-contents-work-item-status">
                                                            ...
                                                            @elseif($history->status === 2)
                                                                <span
                                                                    ...
                                                                    data-bs-toggle="modal"
                                                                    data-revision_id="{{ optional($history->request_revision)->id }}"
                                                                    data-revision_description="{{ optional($history->request_revision)->description }}">
                                                                    {{ __('Revision Details') }}
                                                                </span>
                                                            @endif
                                                        </div>
                                ...
                                <span class="jobFilter-proposal-author-thumb">
                                   <div class="jobFilter-proposal-author-thumb position-relative" style="display:inline-block;">
                                        ...
                                        <span class="profile-status-icon" style="
                                            ...
                                            background-color: {{ Cache::has('user_is_online_' . $order_details?->freelancer->id) ? '#28a745' : '#6c757d' }};">
                                        </span>
                                    </div>
