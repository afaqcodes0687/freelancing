    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('freelancer.bio.links.store') }}">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control @error('color') is-invalid @enderror" 
                                       id="colorText" name="colorText" value="{{ old('color') ?? '#667eea' }}" 
                                       placeholder="#667eea">
                            </div>
                            <small class="form-text text-muted">
                        ...
                        <div class="mb-3" id="featuredField" style="display: none;">
