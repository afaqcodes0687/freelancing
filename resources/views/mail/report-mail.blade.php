...
<div class="mail-container">
    ...
    <div class="inner-wrap">
        <h2>{{ __('Report Status Update') }}</h2>
        <p>{{ __('Hello') }},</p>
        <p>{{ __('Your report status has been updated.') }}</p>
        
        <div class="message-wrap">
            <p><strong>{{ __('Report ID') }}:</strong> #{{ $data['report_id'] }}</p>
            <p><strong>{{ __('Report Title') }}:</strong> {{ $data['title'] }}</p>
            <p><strong>{{ __('New Status') }}:</strong> {{ $data['status'] }}</p>
            @if(isset($data['note']) && !empty($data['note']))
            <p><strong>{{ __('Admin Note') }}:</strong> {{ $data['note'] }}</p>
            @endif
        </div>
