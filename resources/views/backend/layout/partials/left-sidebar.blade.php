    ...
    <div class="dashboard__left__main">
        ...
        <div class="dashboard__bottom mt-5">
            <ul class="dashboard__bottom__list dashboard-list">
                @if (auth()->guard('admin')->check() && auth()->guard('admin')->user()->role === 'employee')

    {{-- Employee ko sirf yeh 2 items dikhengay --}}
...
@else
               ...
               <li class="dashboard__bottom__list__item has-children 
                    @if (request()->is('admin/wallet*') || request()->routeIs('admin.signup.bonus.settings')) active open show @endif">
                    <a href="javascript:void(0)">
                        <i class="fa-solid fa-briefcase"></i> {{ __('Wallet') }}
                    </a>
                    <ul class="submenu">
                        ...
                        <li class="dashboard__bottom__list__item @if (request()->routeIs('admin.signup.bonus.settings')) selected @endif">
                            <a href="{{ route('admin.signup.bonus.settings') }}">
                                {{ __('Signup Bonus Settings') }}
                            </a>
                        </li>
                    </ul>
                </li>
...
{{--                        @endcan--}}
                ...
                <li
                    ...
                    <li
                        ...
                        <li class="dashboard__bottom__list__item @if (request()->routeIs(['admin.subscription.tax.settings'])) selected @endif">
                            <a href="{{ route('admin.subscription.tax.settings') }}">
                                {{ __('Subscription Tax Settings') }}
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="dashboard__bottom__list__item @if (request()->is(['admin/about-us*'])) active @endif">
                    <a href="{{ route('admin.about-us.index') }}"> <i
                                class="fa-solid fa-info-circle"></i>{{ __('About Us') }}</a>
                </li>
