                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <h4 class="card-title">Edit {{ $type === 'app' ? 'App' : 'Website' }} Privacy Policy Page</h4>
                            <div class="btn-group">
                                <a href="{{ route('admin.privacy.policy.edit', ['type' => 'website']) }}" 
                                   class="btn btn-sm {{ $type === 'website' ? 'btn-primary' : 'btn-outline-primary' }}">
                                    Website Policy
                                </a>
                                <a href="{{ route('admin.privacy.policy.edit', ['type' => 'app']) }}" 
                                   class="btn btn-sm {{ $type === 'app' ? 'btn-primary' : 'btn-outline-primary' }}">
                                    App Policy
                                </a>
                            </div>
                        </div>
...
@section('script')
    ...
    <script>
        ...
        // FAQs Management
        let faqIndex = {{ is_array($policy->faqs) ? count($policy->faqs) : 0 }};
