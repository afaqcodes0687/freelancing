                    ...
                    <div class="customMarkup__single__item">
                        ...
                        <div class="customMarkup__single__inner mt-4">
                            ...
                            <form action="{{route('admin.job.approval.settings')}}" method="POST">
                                ...
                                <div class="single-input my-5">
                                    <label class="label-title">{{ __('Connects Required Per Proposal') }}</label>
                                    <input type="number" name="job_proposal_connects" class="form-control" value="{{ get_static_option('job_proposal_connects') ?? 2 }}">
                                </div>
