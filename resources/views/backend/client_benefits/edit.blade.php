            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Edit Client Benefits Page</h4>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.client.benefits.update') }}">
                            @csrf
                            ...
                            <div class="row mb-4">
                                <div class="col-12">
                                    <h5 class="mb-3"><i class="fas fa-star"></i> Key Benefits</h5>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <button type="submit" class="btn btn-primary">
                                        <i class="fas fa-save"></i> Update Client Benefits
                                    </button>
