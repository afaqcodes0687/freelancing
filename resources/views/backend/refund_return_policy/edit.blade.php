            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Edit Refund or Return Policy Page</h4>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.refund.return.policy.update') }}">
                            @csrf
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    <label class="form-label">FAQ Section Heading</label>
                                    <input type="text" name="faq_content" class="form-control"
                                        value="{{ $policy->faq_content ?? 'Frequently Asked Questions (FAQs) Included' }}"
                                        placeholder="FAQ heading shown above the accordion">
                                </div>
                            </div>
                            </div>
