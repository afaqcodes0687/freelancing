...
Route::group(['prefix'=>'client','as'=>'client.'],function() {
    ...
    Route::group(['middleware'=>['auth','userEmailVerify','Google2FA','globalVariable', 'maintains_mode','setlang', 'check.subscription']],function(){
        ...
        Route::controller(JobController::class)->group(function () {
            ...
            Route::post('job/get-skills-by-subcategory','getSkillsBySubcategory')->name('job.get.skills');
        });
        ...
        Route::controller(DashboardController::class)->group(function () {
            Route::group(['prefix'=>'dashboard'],function(){
                ...
                Route::post('send-invitation', 'sendInvitation')->name('send.invitation');
        ...
        Route::controller(AdController::class)->group(function () {
            Route::group(['prefix'=>'ad'],function(){
                ...
                Route::get('paypro-return','paypro_return')->name('ad.paypro.return');
                Route::get('payfast-return','payfast_return')->name('ad.payfast.return');
            });
        });
